<?php 
    ...
    @$erreur="";
        ...
        $sql = "INSERT INTO `municipalite` (`nom`, `id`) VALUES ('$nom_municipalite', '$id_municipalite')";
        ...
        <form action="" method="post">
            <div class="user_details">
                <div class="input_box">
                    ...
                    placeholder="Entrer code municipalité" name="id_municipalite" value="<?php echo @$id_municipalite ?>"
                    >
                </div>
               
                <div class="input_box">
                    <label for="nom">Nom municipalité</label>
                    <input type="text" id="nom"  name="nom_municipalite"    value="<?php echo @$nom_municipalite ?>"
