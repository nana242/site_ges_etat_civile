...
<head>
    ...
    <link rel="stylesheet" href="./css1/form_acte_deces1.css">
...
<!--header fin-->
    <div class="contenair">
        ...
        <form action="acte_deces.php" method="post">
            <div class="user_details">
                <div class="input_box">
                    <label for="code">Code de registre décès</label>
                    <input type="text" id="code"
                    placeholder="Entrer code de registre décès" name="id_municipalite" value="<?php echo @$id_municipalite ?>"
                    >
                </div>
