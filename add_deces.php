        ...
        <form action="" method="post">
            <div class="user_details">
                <div class="input_box">
                    ...
                    placeholder="Entrer code registre" required>
                </div>
                <div class="input_box">
                ...
                <div class="input_box">
                    ...
                    placeholder="Entrer lieu naissance" required>
                </div>
...
<?php
    ...
    if(isset($_POST['valider'])) {
        ...
        $sql = "INSERT INTO `deces` (`code_deces`, `nom`,`prenom`,`sexe`,`date_naiss`,`lieu_naiss`,`date_deces`,`h_deces`, `lieu_deces`,`profession`,`D_defunt`,`c_deces`, `nom_municipalite`)
                             VALUES ('$code_d','$nom','$prenom','$sexe','$date_naiss','$lieu_naiss','$date_deces','$h_deces','$lieu_deces','$profession','$D_defunt','$cause_deces','$nom_municipalite')";
